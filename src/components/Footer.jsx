                    ...
                    <div className="row gx-5">
                        ...
                        <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div className="d-flex flex-column justify-content-start">
                                <NavLink className="text-secondary mb-2" to="/"><i className="bi bi-arrow-right text-primary me-2"></i>Home</NavLink>
                                <NavLink className="text-secondary mb-2" to="/about"><i className="bi bi-arrow-right text-primary me-2"></i>About Us</NavLink>
                                <NavLink className="text-secondary mb-2" to="/classes"><i className="bi bi-arrow-right text-primary me-2"></i>Class Schedule</NavLink>
                                <NavLink className="text-secondary mb-2" to="/trainers"><i className="bi bi-arrow-right text-primary me-2"></i>Our Trainers</NavLink>
                                <NavLink className="text-secondary mb-2" to="/blogs"><i className="bi bi-arrow-right text-primary me-2"></i>Latest Blog</NavLink>
